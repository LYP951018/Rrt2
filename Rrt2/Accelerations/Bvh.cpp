...
std::optional<HitRecord> NodeRef::Hit(const PackedRay& packedRay, const Ray& ray, float tMin,
                                      float tMax) const
{
    switch (GetKind())
    {
...
std::optional<HitRecord> InteriorNode::Hit(const PackedRay& packedRay, const Ray& ray, float tMin,
                                           float tMax) const
{
...
std::optional<HitRecord> Leaf::Hit(const PackedRay& packedRay, const Ray& ray, float tMin,
                                   float tMax) const
{
    std::optional<HitRecord> hitRecord;
