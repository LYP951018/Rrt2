...
int main()
{
    ...
    //这里的 3 指的是 RGB。
    assert(stbi_write_png(".\\result.png", kWidth, kHeight, 3, pngBytes.data(),
                          kWidth * kSizePerPixel) != 0);
}